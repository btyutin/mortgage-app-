                        ...
                        <Stack spacing="24px">
                            <Stack>
                                ...
                                <Tag variant={status.statusName}>
                                    <TagLabel width={'100%'} textAlign={'center'}>{status.text}</TagLabel>
                                </Tag>
                            </Stack>
                            <Stack>
                ...
                <MobxForm
                    ...
                    <Stack spacing={'12px'}>
                        ...
                        <FormControl id="earningCreditPercent">
                            <FormLabel>% Отчислений с выручки в счет погашения кредита*</FormLabel>

                            <TextInput placeholder={'% Отчислений с выручки в счет погашения кредита*'}
                                       type={'number'}
